...
class FundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fund" do
    assert_difference('Fund.count') do
      post funds_url, params: { fund: { domain: @fund.domain, name: @fund.name, subdomain: @fund.subdomain } }
    end
  ...
  test "should update fund" do
    patch fund_url(@fund), params: { fund: { domain: @fund.domain, name: @fund.name, subdomain: @fund.subdomain } }
